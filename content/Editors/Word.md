...
Microsoft Word is an [[WYSIWYG]] editor that is part of the Microsoft Office Suite.
While there are other editors that are focused on [[Documentation]] and provide more functionalities for technical writing, Word is still a widely used solution for writing documentations. 
