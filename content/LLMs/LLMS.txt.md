...
For extensive documentation, the `llms-full.txt` file may become too large to fit into an LLM's context window. In this case, you can reference additional `llms-full.txt` in your `llms.txt`file.
